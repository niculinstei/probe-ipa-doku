...
In diesem Abschnitt, wird die Planung beschrieben. In dieser Phase werden basierend auf den Anforderungen Arbeitspakete erstellt, und in einem GANTT-Diagramm auf die 10 Tage eingeteilt.
...
\begin{longtable}{p{.22\textwidth}|p{.78\textwidth}}
	...
	\hline
	\textbf{Erwartetes Ergebnis}	& Der GANTT-Zeitplan ist anhand der Arbeitspakete erstellt. Es sind alle Arbeitspakete auf dem Zeitplan vorhanden.\\
	\hline
\end{longtable}
